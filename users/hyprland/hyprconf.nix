...
wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
       ...
       # Source a file (multi-file coexec-once = wl-paste -t text --watch clipman store --no-persistnfigs)
      ...
      # windowrule = opacity 0.9 0.7, ^(nemo)$
    ...
    # See https://wiki.hyprland.org/Configuring/Variables/ for more
       ...
       bind = $mainMod, Z, exec, rofi -combi-modi drun,run -theme Arc-Dark -font "hack 12" -show combi -show-icons
